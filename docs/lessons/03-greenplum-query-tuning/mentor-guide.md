...
- PPTX: `artifacts/lesson-03/greenplum-query-tuning-theory.pptx`
...
Готовые скрины: `artifacts/lesson-03/temp-fs/`, `artifacts/lesson-03/plan-screens/temp-*.png`, `spill-*.png`.
