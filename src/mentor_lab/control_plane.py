...
def _lesson03_stage_guides(route: LearningRoute) -> List[StageGuide]:
    ...
    return [
        ...
        StageGuide(
            "homework",
            "28-30",
            "Senior core: graded view + A/B design + e2e + two-way reconcile.",
            [
            ...
            "Что принести на следующий урок?",
            "Rewrite на v_homework_brand_region (не class-demo), A/B evidence, e2e, EXCEPT ALL.",
            f"Senior core pack готов; seed={homework_seed}; graded view ≠ {sql_lab} TEMP.",
            workbook,
            homework,
        ),
    ]
