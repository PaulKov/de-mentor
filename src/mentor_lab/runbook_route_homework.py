                        ...
                        stages=[
                            ...
                            RunbookStage(
                                ...
                                [
                                    ...
                                    "docker compose -f labs/greenplum-625/docker-compose.yml exec -T -u gpadmin greenplum-625 bash -lc '. /usr/local/gpdb/greenplum_path.sh && psql -U gpadmin -d mentor -v ON_ERROR_STOP=1 -f /mentor-lab/examples/partitioning-strategies.sql'",
                                ],
