...
class StudentPortal:
    ...
    def render(self, lab_name: str, version: str = "v1") -> str:
        ...
        commands = [
            ...
            f"python3 mentor-lab.py homework {lab_name} check --submission lessons/lesson-01/submissions/homework.md",
    ...
    def _render_v2(self, lab_name: str) -> str:
        steps = [
            ...
            ("Dataset", f"python3 mentor-lab.py dataset {lab_name} generate --scale small --seed 42 --skew high --late-facts --wide-rows --output artifacts/generated-enterprise.sql"),
            ...
            ("Homework check", f"python3 mentor-lab.py homework {lab_name} check --submission lessons/lesson-01/submissions/homework.md"),
            ("SQL autograde", f"python3 mentor-lab.py autograde-sql {lab_name} --submission labs/greenplum-625/examples/student-solution-example.sql --output artifacts/sql-autograde.md"),
            ...
            ("Live smoke", f"python3 mentor-lab.py ci-smoke {lab_name} --dry-run"),
        ]
        step_cards = "\n".join(
            (
