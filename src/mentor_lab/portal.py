...
class StudentPortal:
    ...
    def _render_v2(self, lab_name: str) -> str:
        steps = [
            ...
            ("SQL autograde", f"python3 mentor-lab.py autograde-sql {lab_name} --submission labs/greenplum/examples/student-solution-example.sql --output artifacts/sql-autograde.md"),
