...
- [Презентация (PowerPoint)](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-03/artifacts/greenplum-query-tuning-theory.pptx)
- [Домашка Senior core](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-03/homework/assignment.md)
- [План домашки](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-03/homework/plan.md)
- [Homework seed](https://github.com/PaulKov/de-mentor/blob/master/labs/greenplum-625/examples/lesson03-homework-seed.sql)
- [Class demo (не копировать в сдачу)](https://github.com/PaulKov/de-mentor/blob/master/labs/greenplum-625/examples/lesson03-class-demo.sql)
- [Evidence template](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-03/homework/templates/evidence.md)
...
- [Шпаргалка](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-03/docs/cheat-sheet.md)
...
- почему выбран distribution ключ **или** почему materialization не окупается;
- где на диске TEMP (`t_*`) vs spill Sort (если создавал TEMP);
- что обязательно сделать после наполнения TEMP (`ANALYZE`).

Self-check:

- before/after при одном optimizer;
- e2e cost (не только final SELECT) хотя бы в черновике;
- residual risk одной фразой **поверх** reconcile, не вместо.
