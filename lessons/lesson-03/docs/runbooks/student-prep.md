...
- Workbook: [student-workbook.md](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-03/docs/student-workbook.md)
- Презентация: [greenplum-query-tuning-theory.pptx](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-03/artifacts/greenplum-query-tuning-theory.pptx)
