...
План выполнения: [homework plan](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/homework/plan.md). На выполнение закладывай 60-90 минут. Следующий урок: `Lesson 02: Partitioning, statistics and incremental loads in MPP`.
...
- Заполни plan-reading ladder из [student workbook](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/student-workbook.md).
