...
- упрощенный runbook: [упрощенный маршрут](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/runbooks/simple-path.md)
- расширенный runbook: [расширенный маршрут](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/runbooks/deep-dive-path.md)
...
- В [homework](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/homework/assignment.md) заполнены facts, dimensions и grain.
- Ученик не подменил grain partition key или primary key.
- Есть ссылка на [student workbook](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/student-workbook.md) как источник базовых упражнений.
...
```bash
docker compose -f labs/greenplum-625/docker-compose.yml exec -T -u gpadmin greenplum-625 \
  bash -lc '. /usr/local/gpdb/greenplum_path.sh && psql -U gpadmin -d mentor -v ON_ERROR_STOP=1 -f /mentor-lab/examples/storage-and-partitioning.sql'

docker compose -f labs/greenplum-625/docker-compose.yml exec -T -u gpadmin greenplum-625 \
  bash -lc '. /usr/local/gpdb/greenplum_path.sh && psql -U gpadmin -d mentor -v ON_ERROR_STOP=1 -f /mentor-lab/examples/partitioning-strategies.sql'
```
...
- В домашке есть проверка `leaf_partitions` через `gp_toolkit.gp_partitions` или `gp_toolkit.gp_partitions`.
...
- Артефакты сдачи из [homework](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/homework/assignment.md) заполнены.
