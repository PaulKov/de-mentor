...
Ссылки: [student workbook](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/student-workbook.md), [homework](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/homework/assignment.md), [cluster inspection SQL](https://github.com/PaulKov/de-mentor/blob/master/labs/greenplum-625/examples/cluster-inspection.sql), [storage and partitioning SQL](https://github.com/PaulKov/de-mentor/blob/master/labs/greenplum-625/examples/storage-and-partitioning.sql).
...
Ссылки: [student workbook](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/student-workbook.md), [homework](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/homework/assignment.md), [cluster inspection SQL](https://github.com/PaulKov/de-mentor/blob/master/labs/greenplum-625/examples/cluster-inspection.sql), [cluster monitoring SQL](https://github.com/PaulKov/de-mentor/blob/master/labs/greenplum-625/examples/cluster-monitoring.sql), [storage and partitioning SQL](https://github.com/PaulKov/de-mentor/blob/master/labs/greenplum-625/examples/storage-and-partitioning.sql), [partitioning strategies SQL](https://github.com/PaulKov/de-mentor/blob/master/labs/greenplum-625/examples/partitioning-strategies.sql).
...
- Ученик называет домашние deliverables из [homework](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/homework/assignment.md).
