...
Используй [презентацию PowerPoint](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/artifacts/greenplum-theory.pptx) вместе с поминутным presenter guide:
...
- упрощенный маршрут: [упрощенный маршрут](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/runbooks/simple-path.md);
- расширенный маршрут: [расширенный маршрут](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/runbooks/deep-dive-path.md);
- маршрут домашки: [план домашки](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/homework/plan.md);
...
- deep dive: [master/segment data path](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/deep-dives/master-segment-data-path.md);
...
- практика ученика: [student workbook](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/student-workbook.md);
- домашка: [homework](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/homework/assignment.md);
...
- [Simple path](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/runbooks/simple-path.md) - основной 60-минутный маршрут: MPP mental model, storage, distribution, skew, EXPLAIN, partitioning intro, homework.
- [Deep-dive path](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/runbooks/deep-dive-path.md) - расширенный 90-120 минут: QD/QE/gang/slices, QueryDispatchDesc, physical joins, Broadcast vs Redistribute, storage caveats.
...
- [QD/QE/gang/slices explained](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/deep-dives/qd-qe-gang-slices-explained.md) - сначала простыми словами, затем технически объяснить QD, QE, slice, gang, Motion и `EXPLAIN`;
- [EXPLAIN plan reading](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/deep-dives/explain-plan-reading.md) - читать план по scan/local work/join/Motion/global work/Rows out;
- [Physical joins in MPP](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/deep-dives/physical-joins-in-mpp.md) - отличать локальный join algorithm от MPP data movement;
- [Partitioning strategies](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/deep-dives/partitioning-strategies.md) - выбирать `PARTITION BY RANGE`, `PARTITION BY LIST`, `PARTITION BY HASH`, смотреть `DEFAULT partition`, no default partitioning, out-of-range INSERT, `leaf_partitions`, `gp_toolkit.gp_partitions`, `gp_toolkit.gp_partitions`, `ATTACH PARTITION`, `DETACH PARTITION`;
- [MPP system taxonomy](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/deep-dives/mpp-system-taxonomy.md) - сравнивать SMP, MPP, EPP, lakehouse и HTAP по bottleneck.
