...
См. [roadmap](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/roadmap.md).
...
Подробные шаги: [student workbook](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/student-workbook.md).
...
`Academy Experience v5` добавляет stateful-session слой поверх существующих workbook/runbook/autograder материалов. Основной интерфейс занятия теперь находится в отдельном repo [de-mentor-portal](https://github.com/PaulKov/de-mentor-portal) и написан на Vue 3 + Nuxt 3 + Vite.
...
- [Гайд ментора](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/mentor-guide.md) - подсказки для проведения урока.
- [Workbook ученика](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/student-workbook.md) - задания для ученика.
- [Подготовка ученика](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/runbooks/student-prep.md) - подготовка окружения ученика для macOS, Windows и Linux.
- [Упрощенный маршрут](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/runbooks/simple-path.md) - 60-минутный маршрут: слайды, команды, вопросы, проверки.
- [Расширенный маршрут](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/runbooks/deep-dive-path.md) - расширенный deep-dive маршрут.
- [План домашки](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/homework/plan.md) - план домашки на 60-90 минут.
- [Шпаргалка](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/cheat-sheet.md) - команды и SQL-шпаргалка.
- [Домашка](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/homework/assignment.md) - домашняя работа.
- [Сквозной кейс](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/case-study.md) - сквозной профессиональный кейс.
- [Карта архитектуры](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/architecture.md) - визуальная карта Greenplum.
- [Матрица оценки](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/homework/rubric.md) - skill matrix и критерии оценки.
- [Финальная задача](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/capstone.md) - финальная архитектурная задача.
- [Контур Academy](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/academy-loop.md) - профессиональный контур: assessment, analyzer, hidden incidents, submit/review, learning loop и certificate.
- [Academy v2](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/academy-v2.md) - портал ученика, visualizer, diagnostics, scenario randomizer, adaptive review и итоговый learning loop.
- [Лабораторная по query tuning](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/query-tuning-lab.md) - усложненные задачи по query tuning.
- [QD/QE/gang/slices explained](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/deep-dives/qd-qe-gang-slices-explained.md) - цельное объяснение QD, QE, slices, gangs, Motion и того, как это видно в `EXPLAIN`.
- [Master/segment data path](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/deep-dives/master-segment-data-path.md) - глубокая техническая схема master/QD/QE, Motion, gpfdist и storage.
- [Чтение EXPLAIN-плана](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/deep-dives/explain-plan-reading.md) - как читать план и формулировать RCA по `EXPLAIN ANALYZE`.
- [Физические joins в MPP](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/deep-dives/physical-joins-in-mpp.md) - физика joins в MPP: co-located, broadcast, redistribute.
- [Стратегии partitioning](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/deep-dives/partitioning-strategies.md) - RANGE / LIST / HASH, DEFAULT partition, no default partitioning, `gp_toolkit.gp_partitions`, `gp_toolkit.gp_partitions`, `leaf_partitions`, `ATTACH PARTITION`, `DETACH PARTITION` и out-of-range INSERT.
- [Таксономия MPP-систем](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/docs/deep-dives/mpp-system-taxonomy.md) - SMP, MPP, EPP, lakehouse, HTAP и цена каждой архитектуры.
- [Теоретическая презентация Greenplum (PowerPoint)](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-01/artifacts/greenplum-theory.pptx) - презентация урока.
