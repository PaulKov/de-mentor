...
- [Упрощенный маршрут](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-02/docs/runbooks/simple-path.md)
- [Deep-dive маршрут](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-02/docs/runbooks/deep-dive-path.md)
...
Переходи на [deep-dive маршрут](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-02/docs/runbooks/deep-dive-path.md), если ученик уверенно отвечает на базовые вопросы.
...
Ссылка на домашку: [homework.md](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-02/homework/assignment.md).
