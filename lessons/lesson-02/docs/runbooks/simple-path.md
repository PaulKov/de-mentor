...
- [Workbook: statistics](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-02/docs/student-workbook.md)
...
Как проверяем: ученик может назвать файл сдачи `lessons/lesson-02/submissions/homework.md` и self-check команды.
