...
Создай файл `lessons/lesson-02/submissions/homework.md`.
...
План выполнения: [homework-plan.md](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-02/homework/plan.md).
