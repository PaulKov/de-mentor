...
Ожидаемый результат: стенд поднят, `check greenplum` зеленый, понятно где [homework.md](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-02/homework/assignment.md).
...
Что сделать: сверить submission с [Матрицей оценки](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-02/homework/rubric.md).

Ожидаемый результат: `lessons/lesson-02/submissions/homework.md` содержит DDL, `EXPLAIN`, catalog checks, statistics policy, validation и residual risk.

Как проверяем: можно показать файл ментору и пройти по критериям приемки из [homework.md](https://github.com/PaulKov/de-mentor/blob/master/lessons/lesson-02/homework/assignment.md).
