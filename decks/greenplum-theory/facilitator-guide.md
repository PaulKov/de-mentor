...
| 28. QD/QE internals with source anchors | 6 | Нужна глубина по QD/QE без чтения всего C-кода. | Source anchors: `cdbdisp_query.c`, `nodeMotion.c`, `nodeHashjoin.c`, `joinpath.c`, `CdbPathLocus`. | Прочитать `qd-qe-gang-slices-explained.md`, затем связать slice/gang/Motion с планом. |
